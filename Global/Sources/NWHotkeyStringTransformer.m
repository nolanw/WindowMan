...
- (id)transformedValue:(id)value
{
  ...
  NSString *keyCodeString = (([hotkey.characterIgnoringModifiers length] > 0) ? [hotkey.characterIgnoringModifiers uppercaseString] : [[self class] stringWithKeyCode:hotkey.keyCode]);
